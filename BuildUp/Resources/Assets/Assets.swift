...
internal enum Asset {
  ...
  internal static let icNoOrders = ImageAsset(name: "ic_no_orders")
  internal static let noCartItems = ImageAsset(name: "no_cart_items")
  internal static let icQrcodeScan = ImageAsset(name: "ic_qrcode_scan")
  ...
  internal static let icCancelled = ImageAsset(name: "ic_cancelled")
  internal static let icDelivered = ImageAsset(name: "ic_delivered")
  ...
  internal static let addToCartFlat = ImageAsset(name: "Add_to_cart_flat")
  ...
  internal static let icDeleteAccount = ImageAsset(name: "ic_delete_account")
  ...
  internal static let icTabbar1CartActive = ImageAsset(name: "ic_tabbar1_cart_active")
  internal static let icTabbar1CartInactive = ImageAsset(name: "ic_tabbar1_cart_inactive")
  internal static let icTabbar1CategoriesActive = ImageAsset(name: "ic_tabbar1_categories_active")
  internal static let icTabbar1CategoriesInactive = ImageAsset(name: "ic_tabbar1_categories_inactive_")
  internal static let icTabbar1HomeActive = ImageAsset(name: "ic_tabbar1_home_active")
  internal static let icTabbar1HomeInactive = ImageAsset(name: "ic_tabbar1_home_inactive")
  internal static let icTabbar1OrdersActive = ImageAsset(name: "ic_tabbar1_orders_active")
  internal static let icTabbar1OrdersInactive = ImageAsset(name: "ic_tabbar1_orders_inactive")
  internal static let icTabbar1ProfileActive = ImageAsset(name: "ic_tabbar1_profile_active")
  internal static let icTabbar1ProfileInactive = ImageAsset(name: "ic_tabbar1_profile_inactive")
  ...
  internal static let icOrderHistoryActive = ImageAsset(name: "ic_orderHistory_active")
  internal static let icOrderHistoryInactive = ImageAsset(name: "ic_orderHistory_inactive")
  ...
  internal static let icTabbar3Cart = ImageAsset(name: "ic_tabbar3_cart")
  internal static let icTabbar3CategoriesActive = ImageAsset(name: "ic_tabbar3_categories_active")
  internal static let icTabbar3CategoriesInactive = ImageAsset(name: "ic_tabbar3_categories_inactive")
  internal static let icTabbar3HomeActive = ImageAsset(name: "ic_tabbar3_home_active")
  internal static let icTabbar3HomeInactive = ImageAsset(name: "ic_tabbar3_home_inactive")
  internal static let icTabbar3OrdersActive = ImageAsset(name: "ic_tabbar3_orders_active")
  internal static let icTabbar3OrdersInactive = ImageAsset(name: "ic_tabbar3_orders_inactive")
  internal static let icTabbar3ProfileActive = ImageAsset(name: "ic_tabbar3_profile_active")
  internal static let icTabbar3ProfileInactive = ImageAsset(name: "ic_tabbar3_profile_inactive")
